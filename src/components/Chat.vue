<template>
    <div>
        ...
        <div class="chat center">
            <button class="enter btn btn-md btn-success float-right" @click="submit(content)"><i
                    class="fa fa-comments"/></button>
            <input type="text" class="chattextbox form-control margin-bottom" placeholder="Type message here..."
                   v-model='content' required="true" autofocus="true" id="chatbox" @keyup.enter="submit(content)">
        </div>
    </div>
</template>
